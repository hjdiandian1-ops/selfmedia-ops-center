...
LOCAL_WORKFLOW = "/Users/xiaowuliao/Projects/自媒体发布agent/nas-n8n/workflows/xhs_gzh_immediate_publish.json"

def import_workflow():
    print("📡 正在通过 SSH Base64 传输 n8n 工作流 JSON 并导入 n8n 容器...")
    ...
    remote_json_path = f"{NAS_SHARED_DIR}/xhs_gzh_immediate_publish.json"
